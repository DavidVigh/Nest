    ...
    <main className="bg-[#cdbbbd]">
      <div className="mx-auto flex flex-col items-center justify-center">
        <div className="min-h-screen flex items-center">
          <section className="container mx-auto flex flex-row items-center justify-evenly bg-gradient-to-t px-4 py-6 md:p-0 from-[#af9295] to-[#ce9672]/40 sm:rounded-xl">
            <div className="container mx-auto flex flex-col">
              ...
              >
                <p className="indent-4 text-justify">
                  ...
                  we're a community gathering place where memories are made over
                ...
                <p className="indent-4 mt-4 text-justify">
                  ...
                  together the finest ingredients, expert craftsmanship, and
                  warm hospitality. Whether you're here for a morning coffee, a
                  leisurely lunch, or an evening treat, we're dedicated to
        ...
        <section className="bg-gradient-to-t from-[#af9295] to-[#ce9672]/40 mt-8 flex flex-col-reverse md:flex-row md:justify-between lg:justify-evenly items-center p-6 mb-20">
          <motion.div className="mt-6 md:mt-0 md:ml-6 text-[#3d2d2f] w-full md:w-2/3 lg:w-1/3 p-4">
            ...
            <motion.p className="mt-8 text-lg first-letter:text-2xl"
                initial={{ opacity: 0, x: -40 }}
                transition={{ ease: "easeOut", duration: 1.2 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
            >
                Behind every dish and every cup is a team of passionate individuals committed to excellence. We believe in creating not just meals, but experiences that bring people together. 
            </motion.p>
          </motion.div>
